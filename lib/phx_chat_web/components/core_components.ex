defmodule PhxChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxChatWeb.Gettext, "errors", msg, opts)
    end
  end
